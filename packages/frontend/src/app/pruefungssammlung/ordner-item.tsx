        ...
        <>
            ...
            >
                ...
                <div className="mr-0 flex flex-row gap-2">
                    <div className="p-1 cursor-pointer opacity-30 hover:opacity-100" onClick={() => setShowForm(true)}>
                        <FaLink />
                    </div>
                </div>
            </div>
            <Modal show={showForm} onClose={() => setShowForm(false)}>
                ...
                <div>
                    <p className="mb-1">
                        Wir schicken dir den Zugriff auf den Prüfungsordner <b>{info.name}</b> als Link per Mail! Dieser
                        ist dann 14 Tage gültig.
                    </p>
                ...
                <div className="mb-2">
                    ...
                    {formError && <p className="text-sm text-red-500">Die Matrikelnummer sollte 8-stellig sein.</p>}
            ...
            <Modal show={showSuccess} onClose={() => setShowSuccess(false)}>
                <div className="mr-6 flex flex-row gap-4 items-center">
                    ...
                    <p>
                        Wir haben dir einen Link per Mail geschickt. Falls du nach ein paar Minuten noch nichts erhalten
                        hast, bitte prüfe auch deinen Spam-Ordner.
                    </p>
                </div>
