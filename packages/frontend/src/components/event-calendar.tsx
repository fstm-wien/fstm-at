        ...
        <Modal show={show} onClose={onClose}>
            ...
            <div>
                ...
                <div className="flex flex-row">
                    ...
                    />
                    <button
                        className="px-4 py-2 bg-orange-400 text-white rounded-r-lg hover:bg-orange-500 transition"
                        onClick={handleCopy}
                        disabled={copied}
        ...
        <>
            ...
            <div className="w-full">
                <div className="flex flex-row justify-between flex-wrap">
                    ...
                    <a className="hover:text-orange-400 transition-colors" onClick={() => setShowCalendarExport(true)}>
                        Kalender abbonieren
                    </a>
                </div>
                <FullCalendar
